...
STD_LIB_LIST = {
    ...
    "_get_Str": [
        ...
        # Store the length in a register, such that we can create (length, first*) later on
        Line(Instruction.LDR, 7),
        Line(Instruction.STR, 6),
        # If length == 0:
        Line(Instruction.LDR, 7),
        Line(Instruction.LDC, 0),
        Line(Instruction.EQ),
    ...
    "_reverse_List_Char": [
        ...
        Line(Instruction.LINK, 2),
        Line(Instruction.LDC, 0),
        Line(Instruction.LDC, 47806),
        Line(Instruction.STMH, 2),
        Line(Instruction.STL, 1, comment="Store 'reversed' locally."),
        Line(Instruction.LDC, 0, 0),
        Line(Instruction.LDL, -2, comment="x"),
        Line(Instruction.BSR, "_length"),
        Line(Instruction.AJS, -1),
        Line(Instruction.LDR, "RR"),
        Line(Instruction.LDC, 1, 1),
        Line(Instruction.SUB, comment="length(x) - 1"),
        Line(Instruction.BSR, "_ListAbbr"),
        Line(Instruction.AJS, -2),
        Line(Instruction.LDR, "RR"),
        Line(Instruction.LDMH, 0, 2),
        Line(label="_ForLoop_reverse"),
        Line(Instruction.LINK, 0),
        Line(Instruction.LDL, -2),
        Line(Instruction.BRF, "_ForEnd_reverse"),
        Line(Instruction.LDL, -2),
        Line(Instruction.LDC, 1),
        Line(Instruction.SUB),
        Line(Instruction.STL, -2),
        ...
        Line(
            Instruction.STL,
            2,
            comment="for i in [0..length(x) - 1] {     reversed = x[i] : reversed; })",
        ),
        Line(Instruction.LDL, -2, comment="x"),
        Line(Instruction.LDH, 0),
        Line(Instruction.LDL, 2, comment="i"),
        ...
        Line(Instruction.SWP),
        Line(Instruction.AJS, -1),
        Line(Instruction.STL, 1, comment="reversed = x[i] : reversed"),
        Line(Instruction.BRA, "_ForLoop_reverse"),
        Line(label="_ForEnd_reverse"),
        Line(Instruction.UNLINK),
        Line(Instruction.AJS, -2),
        Line(Instruction.LDL, 1, comment="reversed"),
        Line(Instruction.STR, "RR"),
        Line(Instruction.UNLINK),
        Line(Instruction.RET, comment="return reversed"),
    ],
}
