...
STD_LIB_LIST = {
    ...
    "_reverse_List_Char": [
        ...
        Line(Instruction.BRF, "_IfEnd0_reverse_List_Char"),
        Line(label="_Then0_reverse_List_Char"),
        Line(Instruction.LDL, 1, comment="reversed"),
        Line(Instruction.STR, "RR"),
        Line(Instruction.UNLINK),
        Line(Instruction.RET, label="return_reversed"),
        Line(label="_IfEnd0_reverse_List_Char"),
        Line(Instruction.LDC, 0, comment="0"),
        ...
        Line(label="_ForLoop0_reverse_List_Char"),
        Line(Instruction.LINK, 0),
        Line(Instruction.LDL, -2),
        Line(Instruction.BRF, "_ForEndLink0_reverse_List_Char"),
        Line(Instruction.LDL, -2),
        Line(Instruction.LDC, 1),
        Line(Instruction.SUB),
        Line(Instruction.STL, -2),
        ...
        Line(Instruction.BRA, "_ForLoop0_reverse_List_Char"),
        Line(label="_ForEndLink0_reverse_List_Char"),
        Line(Instruction.UNLINK),
        Line(label="_ForEnd0_reverse_List_Char"),
        Line(Instruction.AJS, -2),
        Line(Instruction.LDL, 1, comment="reversed"),
        Line(Instruction.STR, "RR"),
        Line(Instruction.UNLINK),
